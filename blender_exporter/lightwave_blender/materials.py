...
def export_default_feather_spine_bsdf():
    node = XMLNode("bsdf", type="diffuse")
    node.add("texture", name="albedo", type="constant", value="0.04817,0.03689,0.02029")
    return [node]

def export_default_feather_barbs_bsdf():
    node = XMLNode("bsdf", type="diffuse")
    node.add("texture", name="albedo", type="ringed", color0="0.03071,0.02624,0.01600", color1="0.61721,0.66539,0.55834")
    return [node]

def export_default_feather_barbules_bsdf():
    node = XMLNode("bsdf", type="diffuse")
    node.add("texture", name="albedo", type="constant", value="0.01521,0.01033,0.0")
    return [node]
